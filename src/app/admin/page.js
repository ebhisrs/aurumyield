  ...
  return (
    <div className="app-layout">
      <aside className="app-sidebar">
        <div className="brand" style={{marginBottom:34}}><div className="brand-mark">A</div><div><span style={{fontWeight:900,fontSize:18}}>AurumYield</span><small style={{display:'block',color:'var(--muted)',fontWeight:600,fontSize:12}}>Admin</small></div></div>
